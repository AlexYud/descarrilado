...
func _populate_graphics_options() -> void:
	...
	quality_option.add_item("Low", QUALITY_LOW)
	quality_option.add_item("Medium", QUALITY_MEDIUM)
	quality_option.add_item("High", QUALITY_HIGH)
	...
	fps_limit_option.add_item("Uncapped", 0)
